...
def build_runner(trace: bool):
    ...
    voter_llms = [                                          # Level 1 — cheapest
        gemini_direct_chat("gemini-2.5-flash-lite",        temperature=0.1, max_tokens=8192),
        gemini_direct_chat("gemini-2.5-flash-lite",        temperature=0.3, max_tokens=8192),
        anthropic_direct_chat("claude-haiku-4-5-20251001", temperature=0.1, max_tokens=8192),
    ]

    level2_voter_llms = [                                  # Level 2 — mid-tier
        gemini_direct_chat("gemini-2.5-flash",             temperature=0.1, max_tokens=8192),
        gemini_direct_chat("gemini-2.5-flash",             temperature=0.3, max_tokens=8192),
        anthropic_direct_chat("claude-haiku-4-5-20251001", temperature=0.3, max_tokens=8192),
    ]

    escalation_llm = anthropic_direct_chat(                # Level 3 — strongest
        "claude-sonnet-4-6", temperature=0.0, max_tokens=8192
    )
...
def build_batch_runner():
    ...
    l1_voters = [
        VoterBatchConfig("gemini-2.5-flash-lite",      provider="gemini", max_tokens=8192, temperature=0.1),
        VoterBatchConfig("gemini-2.5-flash-lite",      provider="gemini", max_tokens=8192, temperature=0.3),
        # VoterBatchConfig("gpt-4o-mini",              provider="openai"),  # insufficient quota
        VoterBatchConfig("claude-haiku-4-5-20251001",  provider="claude", max_tokens=8192, temperature=0.1),
    ]
    l2_voters = [
        VoterBatchConfig("gemini-2.5-flash",           provider="gemini", max_tokens=8192, temperature=0.1),
        VoterBatchConfig("gemini-2.5-flash",           provider="gemini", max_tokens=8192, temperature=0.3),
        # VoterBatchConfig("gpt-4.1-mini",             provider="openai"),  # insufficient quota
        VoterBatchConfig("claude-haiku-4-5-20251001",  provider="claude", max_tokens=8192, temperature=0.3),
    ]
    ...
    escalation_llm = anthropic_direct_chat("claude-sonnet-4-6", temperature=0.0, max_tokens=8192)
